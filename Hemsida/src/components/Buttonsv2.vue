...
export default {
  ...
  //funktioner som man kan lägga på logik på data variabler 
  //exempel om man vill sortera logglistan 
  computed: {
    Disconnect() {
  ...
  // funktioner som ska reagera på ändringar av data i applikationen
  watch: {
    //typ av watch funktion i det här fallet disconnectar från mqtt
    Disconnect: {
  ...
  methods: {
    ...
    Connect() {
      ...
      //kopplar upp sig till mqtt servern med användaruppgifter från connectionsettingskomponenten eller default värden från store.js
      ...
      //uppdaterar state med att vi är anslutna
    ...
    // callback funktion från mqtt servern
    ...
    //funktion som skickar meddelanden eller publishar till mqtt
    Send(adress, message) {
      // console.log(message);
      this.client.publish(
